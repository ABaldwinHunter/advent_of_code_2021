...
#
# This is purely copied from the article above
#
# It seems like ruby does not have a built in implementation
# of Priority queue, which some languages seem to
#
class PriorityQueue
  def initialize
    @elements = [nil]
